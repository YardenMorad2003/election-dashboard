...
- **Israel Polarization Panel** — Gidron, Noam; Sheffer, Lior; Mor, Guy, 2022, *"The Israel Polarization Panel Dataset, 2019–2021"*, [doi:10.7910/DVN/A6AA4X](https://doi.org/10.7910/DVN/A6AA4X), Harvard Dataverse, V2 (adds an 11th wave, January 2023). Used as the transfers page's true-panel validation layer; all processing and interpretation are this site's own.
